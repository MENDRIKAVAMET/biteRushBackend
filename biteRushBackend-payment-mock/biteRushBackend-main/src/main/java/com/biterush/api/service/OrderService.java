...
public class OrderService {
    ...
    /**
     * Commandes du client actuellement connecté (GET /orders/my-orders).
     */
    @Transactional(readOnly = true)
    ...
    /**
     * Appelé par PaymentService lorsqu'un paiement (mock) réussit.
     * Fait passer la commande EN_ATTENTE -> CONFIRMEE et crée la livraison si besoin.
     */
